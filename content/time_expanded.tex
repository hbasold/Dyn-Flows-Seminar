...
\begin{enumerate}[label={(A\arabic*)}]
    \item Die optimale Laufzeit in $(\graph, \widetilde{\tau})$ approximiert die optimale
        ...
        wenn $|\widetilde{\tau}(e) - \tau(e)| \leq (1 + \eps)$. \label{a1}
\end{enumerate}
...
\begin{example}
    ...
    interpretiert werden, muss fast der komplette Fluss verworfen werden.
...
\begin{enumerate}[resume, label={(A\arabic*)}]
    \item Eine Lösung $\widetilde{f}$ in $(\graph, \widetilde{\tau})$ muss
        ...
        umgewandelt werden können: $||\widetilde{f}| - |f|| \leq (1+\eps)$.
\end{enumerate}
